...
public class IntegrationTest {
	...
	public void testModify() throws Exception {
		...
		VacationRequestAssert.assertThat(vacationRequest).hasStatus(VacationRequestStatus.PENDING.getStatus())
				...
				.hasNewRequestProcessInstanceId(newVacationRequestProcessInstanceId)
				.hasRequesterBonitaBPMId(session.getUserId())
				.hasReturnDate((Date) modifyVacationRequestInputs.get("returnDateContract"))
				.hasStartDate((Date) modifyVacationRequestInputs.get("startDateContract"));
	...
	private Map<String, Serializable> modifyVacationRequestInputs(String vacationRequestId) {
		...
		Date in2Days = DateCreator.createInXDays(2);
		Date in4Days = DateCreator.createInXDays(4);
